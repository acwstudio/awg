                    ...
                    <div class="col-lg-5 mb-all-40">
                        ...
                        <div class="tab-content">
                            <div id="thumb1" class="tab-pane fade show active">
                                <a data-fancybox="images" href="{{ asset("storage/" . $product->img_full_name) }}">
                                    <img src="{{ asset("storage/" . $product->img_full_name) }}" alt="product-view"></a>
                            </div>
                        ...
                        <div class="product-thumbnail mt-15">
                            <div class="thumb-menu owl-carousel nav tabs-area" role="tablist">
                                <a class="active" data-toggle="tab" href="#thumb1">
                                    <img src="{{ asset("storage/" . $product->img_full_name) }}" alt="product-thumbnail"></a>
